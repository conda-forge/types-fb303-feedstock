...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-fb303-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13123&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-fb303-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-fb303` can be installed with:

```
conda install types-fb303
```

It is possible to list all of the versions of `types-fb303` available on your platform with:
